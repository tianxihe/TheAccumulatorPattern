...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 6
    answer = count_cosines_from(3, 9, -0.98)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 0
    answer = count_cosines_from(8, 9, 2)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected =4
    answer = count_cosines_from(3, 9, -0.16)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 1.833333  # This is APPROXIMATELY the correct answer.
